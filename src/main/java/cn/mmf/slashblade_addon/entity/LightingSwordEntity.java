...
public class LightingSwordEntity extends BlisteringSwordsEntity {
	...
	public static LightingSwordEntity createInstance(PlayMessages.SpawnEntity packet, Level worldIn) {
		return new LightingSwordEntity(SBAEntitiesRegistry.LightingSwords, worldIn);
	}
